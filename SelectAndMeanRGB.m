...
Original_image_dir = ['D:\dataset_denoising\Canon_80D_8_8_6400_comproom']; % d(j).name];
...
fprintf(['The darkest image is ' im_dir(Index(1)).name '.\n']);
fprintf(['The brightest image is ' im_dir(Index(end)).name '.\n']);
